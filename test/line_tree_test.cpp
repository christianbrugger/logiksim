...
TEST(LineTree, TestSizeSegmentIterator) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{0, 0}, {10, 0}}, 0, 10, false};
    auto line1 = LineTree::sized_line_t {line_t {{10, 0}, {10, 12}}, 10, 22, false};
    auto line2 = LineTree::sized_line_t {line_t {{10, 12}, {20, 12}}, 22, 32, false};
...
TEST(LineTree, MergeTreesSimple) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{0, 0}, {0, 10}}, 0, 10, false};
    auto line1 = LineTree::sized_line_t {line_t {{0, 10}, {10, 10}}, 10, 20, false};
...
TEST(LineTree, MergeTreesLongChain) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{0, 0}, {0, 10}}, 0, 10, false};
    auto line1 = LineTree::sized_line_t {line_t {{0, 10}, {10, 10}}, 10, 20, false};
    auto line2 = LineTree::sized_line_t {line_t {{10, 10}, {10, 0}}, 20, 30, false};
    auto line3 = LineTree::sized_line_t {line_t {{10, 0}, {20, 0}}, 30, 40, false};
    auto line4 = LineTree::sized_line_t {line_t {{20, 0}, {20, 10}}, 40, 50, false};
    auto line5 = LineTree::sized_line_t {line_t {{20, 10}, {30, 10}}, 50, 60, false};
    auto line6 = LineTree::sized_line_t {line_t {{30, 10}, {30, 0}}, 60, 70, false};
...
TEST(LineTree, MergeTreesLongChainInverter) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{30, 0}, {30, 10}}, 0, 10, false};
    auto line1 = LineTree::sized_line_t {line_t {{30, 10}, {20, 10}}, 10, 20, false};
    auto line2 = LineTree::sized_line_t {line_t {{20, 10}, {20, 0}}, 20, 30, false};
    auto line3 = LineTree::sized_line_t {line_t {{20, 0}, {10, 0}}, 30, 40, false};
    auto line4 = LineTree::sized_line_t {line_t {{10, 0}, {10, 10}}, 40, 50, false};
    auto line5 = LineTree::sized_line_t {line_t {{10, 10}, {0, 10}}, 50, 60, false};
    auto line6 = LineTree::sized_line_t {line_t {{0, 10}, {0, 0}}, 60, 70, false};
...
TEST(LineTree, MergeWithTriangle) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{0, 10}, {10, 10}}, 0, 10, false};
    auto line1 = LineTree::sized_line_t {line_t {{10, 10}, {10, 0}}, 10, 20, false};
    auto line2 = LineTree::sized_line_t {line_t {{10, 10}, {20, 10}}, 10, 20, true};
...
TEST(LineTree, MergeCompleteOveralapp) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{0, 0}, {30, 0}}, 0, 30, false};
...
TEST(LineTree, MergeAndSplit) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{0, 0}, {20, 0}}, 0, 20, false};
    auto line1 = LineTree::sized_line_t {line_t {{20, 0}, {20, 10}}, 20, 30, false};
    auto line2 = LineTree::sized_line_t {line_t {{20, 0}, {30, 0}}, 20, 30, true};
...
TEST(LineTree, MergerSplitInsideLine) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{0, 0}, {10, 0}}, 0, 10, false};
    auto line1 = LineTree::sized_line_t {line_t {{10, 0}, {10, 10}}, 10, 20, false};
    auto line2 = LineTree::sized_line_t {line_t {{10, 0}, {20, 0}}, 10, 20, true};
...
TEST(LineTree, MergeThreeTrees) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{0, 0}, {0, 1}}, 0, 1, false};
    auto line1 = LineTree::sized_line_t {line_t {{0, 1}, {0, 2}}, 1, 2, false};
    auto line2 = LineTree::sized_line_t {line_t {{0, 2}, {0, 5}}, 2, 5, false};
    auto line3 = LineTree::sized_line_t {line_t {{0, 2}, {2, 2}}, 2, 4, true};
    auto line4 = LineTree::sized_line_t {line_t {{0, 1}, {1, 1}}, 1, 2, true};
...
TEST(LineTree, RerootSimple) {
    ...
    auto line0 = LineTree::sized_line_t {line_t {{10, 0}, {0, 0}}, 0, 10, false};
