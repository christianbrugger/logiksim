...
[[nodiscard]] auto wheel_zoom(const point_device_fine_t& position,
                              angle_delta_t angle_delta, const ViewConfig& view_config)
    -> ViewPoint;
...
[[nodiscard]] auto wheel_scroll_vertical_view_point(angle_delta_t angle_delta,
...
[[nodiscard]] auto wheel_scroll_horizontal(angle_delta_t angle_delta,
                                           const ViewConfig& view_config) -> point_fine_t;
[[nodiscard]] auto wheel_scroll_horizontal_view_point(angle_delta_t angle_delta,
                                                      const ViewConfig& view_config)
    -> ViewPoint;
