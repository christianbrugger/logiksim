#ifndef LOGICSIM_ALGORITHM_MERGED_ANY_OF_H
#define LOGICSIM_ALGORITHM_MERGED_ANY_OF_H
...
auto merged_any_of(const R1& r1, const R2& r2, Comp comp = {}, Pred pred = {}) -> bool {
    return merged_any_of(std::ranges::begin(r1), std::ranges::end(r1),
