#ifndef LOGIKSIM_MAIN_EDITABLE_CIRCUIT_H
#define LOGIKSIM_MAIN_EDITABLE_CIRCUIT_H
...
class OldEditableCircuit {
   public:
    [[nodiscard]] explicit OldEditableCircuit();
    [[nodiscard]] explicit OldEditableCircuit(Layout&& layout);
...
class ScopedSelection {
   public:
    explicit ScopedSelection(OldEditableCircuit& editable_circuit);
    explicit ScopedSelection(OldEditableCircuit& editable_circuit, Selection selection);
    ~ScopedSelection();

    [[nodiscard]] auto selection_id() const -> selection_id_t;

   private:
    gsl::not_null<OldEditableCircuit*> editable_circuit_;
