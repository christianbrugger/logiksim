...
namespace logicsim {
	...
	void create_placeholder(CircuitGraph& graph, element_id_t element, connection_size_t output) {
	...
	void create_placeholders(CircuitGraph& graph, element_id_t element) {
