#ifndef LOGICSIM_GUI_COMPONENT_CIRCUIT_WIDGET_MOUSE_LOGIC_MOUSE_LOGIC_RESULT_H
#define LOGICSIM_GUI_COMPONENT_CIRCUIT_WIDGET_MOUSE_LOGIC_MOUSE_LOGIC_RESULT_H
